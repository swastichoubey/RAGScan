...
Detection is done by dedicated ML models (a fine-tuned DistilBERT classifier for injection, spaCy NER for PII) trained to recognize these patterns directly, rather than asking an LLM to judge the output. Currently using placeholder stubs.
